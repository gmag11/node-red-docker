...
Let's dissect that command:
        ...
        nodered/node-red        - the image to base it on - currently Node-RED v1.2.7
...
Running that command should give a terminal window with a running instance of Node-RED.
        ...
        10 Oct 12:57:10 - [info] Node-RED version: v1.2.7
...
|----------------------------|--------|----------|------------|-------|------------------------|
| 1.2.7-10-amd64             |   10   | amd64    |   2.x 3.x  |  yes  | amd64/node:10-alpine   |
| 1.2.7-10-arm32v6           |   10   | arm32v6  |   2.x 3.x  |  yes  | arm32v6/node:10-alpine |
| 1.2.7-10-arm32v7           |   10   | arm32v7  |   2.x 3.x  |  yes  | arm32v7/node:10-alpine |
| 1.2.7-10-arm64v8           |   10   | arm64v8  |   2.x 3.x  |  yes  | arm64v8/node:10-alpine |
| 1.2.7-10-s390x             |   10   | s390x    |   2.x 3.x  |  yes  | s390x/node:10-alpine   |
| 1.2.7-10-i386              |   10   | i386     |   2.x 3.x  |  yes  | i386/node:10-alpine    |
|                            |        |          |            |       |                        |
| 1.2.7-10-minimal-amd64     |   10   | amd64    |     no     |  no   | amd64/node:10-alpine   |
| 1.2.7-10-minimal-arm32v6   |   10   | arm32v6  |     no     |  no   | arm32v6/node:10-alpine |
| 1.2.7-10-minimal-arm32v7   |   10   | arm32v7  |     no     |  no   | arm32v7/node:10-alpine |
| 1.2.7-10-minimal-arm64v8   |   10   | arm64v8  |     no     |  no   | arm64v8/node:10-alpine |
| 1.2.7-10-minimal-s390x     |   10   | s390x    |     no     |  no   | s390x/node:10-alpine   |
| 1.2.7-10-minimal-i386      |   10   | i386     |     no     |  no   | i386/node:10-alpine    |


| **Tag**                    |**Node**| **Arch** | **Python** |**Dev**| **Base Image**         |
|----------------------------|--------|----------|------------|-------|------------------------|
| 1.2.7-12-amd64             |   12   | amd64    |   2.x 3.x  |  yes  | amd64/node:12-alpine   |
| 1.2.7-12-arm32v6           |   12   | arm32v6  |   2.x 3.x  |  yes  | arm32v6/node:12-alpine |
| 1.2.7-12-arm32v7           |   12   | arm32v7  |   2.x 3.x  |  yes  | arm32v7/node:12-alpine |
| 1.2.7-12-arm64v8           |   12   | arm64v8  |   2.x 3.x  |  yes  | arm64v8/node:12-alpine |
| 1.2.7-12-s390x             |   12   | s390x    |   2.x 3.x  |  yes  | s390x/node:12-alpine   |
| 1.2.7-12-i386              |   12   | i386     |   2.x 3.x  |  yes  | i386/node:12-alpine    |
|                            |        |          |            |       |                        |
| 1.2.7-12-minimal-amd64     |   12   | amd64    |     no     |  no   | amd64/node:12-alpine   |
| 1.2.7-12-minimal-arm32v6   |   12   | arm32v6  |     no     |  no   | arm32v6/node:12-alpine |
| 1.2.7-12-minimal-arm32v7   |   12   | arm32v7  |     no     |  no   | arm32v7/node:12-alpine |
| 1.2.7-12-minimal-arm64v8   |   12   | arm64v8  |     no     |  no   | arm64v8/node:12-alpine |
| 1.2.7-12-minimal-s390x     |   12   | s390x    |     no     |  no   | s390x/node:12-alpine   |
| 1.2.7-12-minimal-i386      |   12   | i386     |     no     |  no   | i386/node:12-alpine    |
...
|----------------------------------------|--------------------------------------------|
| latest, 1.2.7,                         | nodered/node-red:1.2.7-10-amd64            |
| latest-10, 1.2.7-10                    | nodered/node-red:1.2.7-10-arm32v6          |
|                                        | nodered/node-red:1.2.7-10-arm32v7          |
|                                        | nodered/node-red:1.2.7-10-arm64v8          |
|                                        | nodered/node-red:1.2.7-10-s390x            |
|                                        | nodered/node-red:1.2.7-10-i386             |
|                                        |                                            |
| latest-minimal, 1.2.7-minimal,         | nodered/node-red:1.2.7-10-amd64-minimal    |
| latest-10-minimal, 1.2.7-10-minimal    | nodered/node-red:1.2.7-10-arm32v6-minimal  |
|                                        | nodered/node-red:1.2.7-10-arm32v7-minimal  |
|                                        | nodered/node-red:1.2.7-10-arm64v8-minimal  |
|                                        | nodered/node-red:1.2.7-10-s390x-minimal    |
|                                        | nodered/node-red:1.2.7-10-i386-minimal     |

| **Tag**                                | **Node-RED Base Image**                    |
|----------------------------------------|--------------------------------------------|
| latest-12, 1.2.7-12                    | nodered/node-red:1.2.7-12-amd64            |
|                                        | nodered/node-red:1.2.7-12-arm32v6          |
|                                        | nodered/node-red:1.2.7-12-arm32v7          |
|                                        | nodered/node-red:1.2.7-12-arm64v8          |
|                                        | nodered/node-red:1.2.7-12-s390x            |
|                                        | nodered/node-red:1.2.7-12-i386             |
|                                        |                                            |
| latest-12-minimal, 1.2.7-12-minimal    | nodered/node-red:1.2.7-12-amd64-minimal    |
|                                        | nodered/node-red:1.2.7-12-arm32v6-minimal  |
|                                        | nodered/node-red:1.2.7-12-arm32v7-minimal  |
|                                        | nodered/node-red:1.2.7-12-arm64v8-minimal  |
|                                        | nodered/node-red:1.2.7-12-s390x-minimal    |
|                                        | nodered/node-red:1.2.7-12-i386-minimal     |
...
For example: suppose you are running on a Raspberry PI 3B, which has `arm32v7` as architecture. Then just run the following command to pull the image (tagged by `1.2.7-10-arm32v7`), and run the container.
```
docker run -it -p 1880:1880 -v node_red_data:/data --name mynodered nodered/node-red:latest
```

The same command can be used for running on an amd64 system, since docker discovers its running on a amd64 host and pulls the image with the matching tag (`1.2.7-10-amd64`).
...
```
docker run -it -p 1880:1880 -v node_red_data:/data --name mynodered nodered/node-red:1.2.7-10-minimal-arm32v6
...
The main sections to modify are
    ...
    "dependencies": {
        "node-red": "^1.2.7",           <-- set the version of Node-RED here
